...
var AJV8Validator = function() {
  function AJV8Validator2(options, localizer) {
    this.ajv = void 0;
    this.localizer = void 0;
    var additionalMetaSchemas = options.additionalMetaSchemas, customFormats = options.customFormats, ajvOptionsOverrides = options.ajvOptionsOverrides, ajvFormatOptions = options.ajvFormatOptions, AjvClass = options.AjvClass;
    this.ajv = createAjvInstance(additionalMetaSchemas, customFormats, ajvOptionsOverrides, ajvFormatOptions, AjvClass);
    this.localizer = localizer;
  }
  var _proto = AJV8Validator2.prototype;
  ...
  _proto.transformRJSFValidationErrors = function transformRJSFValidationErrors(errors, uiSchema) {
    ...
    return errors.map(function(e) {
      var instancePath = e.instancePath, keyword = e.keyword, params = e.params, schemaPath = e.schemaPath, parentSchema = e.parentSchema, rest = _objectWithoutPropertiesLoose(e, _excluded);
      var _rest$message = rest.message, message = _rest$message === void 0 ? "" : _rest$message;
      ...
      if ("missingProperty" in params) {
        ...
        var uiSchemaTitle = getUiOptions(get_default(uiSchema, "" + property.replace(/^\./, ""))).title;
        if (uiSchemaTitle) {
          message = message.replace(currentProperty, uiSchemaTitle);
        } else {
          var parentSchemaTitle = get_default(parentSchema, [PROPERTIES_KEY, currentProperty, "title"]);
        ...
        var _uiSchemaTitle = getUiOptions(get_default(uiSchema, "" + property.replace(/^\./, ""))).title;
        if (_uiSchemaTitle) {
